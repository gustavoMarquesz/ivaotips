...
class FevReport extends StatefulWidget {
  @override
  _FevReportState createState() => _FevReportState();
}

class _FevReportState extends State<FevReport> {
  ...
  Future<void> _loadData() async {
    ...
    final List<String>? transactionsJson = prefs.getStringList('transactions_fev');
    final double? bancaValue = prefs.getDouble('bancaValue_fev');
  ...
  Future<void> _saveData() async {
    ...
    await prefs.setStringList('transactions_fev', transactionsJson);

    await prefs.setDouble('bancaValue_fev', _bancaValue);
  }
