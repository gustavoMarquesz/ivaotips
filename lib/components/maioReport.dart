...
class MaioReport extends StatefulWidget {
  @override
  _MaioReportReportState createState() => _MaioReportReportState();
}

class _MaioReportReportState extends State<MaioReport > {
  ...
  Future<void> _loadData() async {
    ...
    final List<String>? transactionsJson = prefs.getStringList('transactions_maio');
    final double? bancaValue = prefs.getDouble('bancaValue_maio');
  ...
  Future<void> _saveData() async {
    ...
    await prefs.setStringList('transactions_maio', transactionsJson);

    await prefs.setDouble('bancaValue_maio', _bancaValue);
  }
