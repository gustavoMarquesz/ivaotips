...
class MarcReport extends StatefulWidget {
  @override
  _MarcReportReportState createState() => _MarcReportReportState();
}

class _MarcReportReportState extends State<MarcReport> {
  ...
  Future<void> _loadData() async {
    ...
    final List<String>? transactionsJson = prefs.getStringList('transactions_marc');
    final double? bancaValue = prefs.getDouble('bancaValue_marc');
  ...
  Future<void> _saveData() async {
    ...
    await prefs.setStringList('transactions_marc', transactionsJson);

    await prefs.setDouble('bancaValue_marc', _bancaValue);
  }
