...
class JaneiroReport extends StatefulWidget {
  @override
   _JaneiroReportState createState() => _JaneiroReportState ();
}

class _JaneiroReportState  extends State<JaneiroReport> {
  ...
  Future<void> _loadData() async {
    ...
    final List<String>? transactionsJson = prefs.getStringList('transactions_jan');
    final double? bancaValue = prefs.getDouble('bancaValue_jan');
  ...
  Future<void> _saveData() async {
    ...
    await prefs.setStringList('transactions_jan', transactionsJson);

    await prefs.setDouble('bancaValue_jan', _bancaValue);
  }
