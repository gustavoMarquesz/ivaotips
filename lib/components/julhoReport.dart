...
class JulhoReport extends StatefulWidget {
  @override
  _JulhoReportReportState createState() => _JulhoReportReportState();
}

class _JulhoReportReportState extends State<JulhoReport > {
  ...
  Future<void> _loadData() async {
    ...
    final List<String>? transactionsJson = prefs.getStringList('transactions_julho');
    final double? bancaValue = prefs.getDouble('bancaValue_julho');
  ...
  Future<void> _saveData() async {
    ...
    await prefs.setStringList('transactions_julho', transactionsJson);

    await prefs.setDouble('bancaValue_julho', _bancaValue);
  }
@override
  void initState() {
