...
class AbrilReport extends StatefulWidget {

  
  @override
  _AbrilReportReportState createState() => _AbrilReportReportState();
}

class _AbrilReportReportState extends State<AbrilReport> {
  ...
  Future<void> _loadData() async {
    ...
    final List<String>? transactionsJson = prefs.getStringList('transactions_abril');
    final double? bancaValue = prefs.getDouble('bancaValue_abril');
  ...
  Future<void> _saveData() async {
    ...
    await prefs.setStringList('transactions_abril', transactionsJson);

    await prefs.setDouble('bancaValue_abril', _bancaValue);
  }
