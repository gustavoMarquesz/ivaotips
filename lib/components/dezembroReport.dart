...
class DezReport extends StatefulWidget {
  @override
   _DezReportState createState() => _DezReportState();
}

class  _DezReportState extends State< DezReport> {
  ...
  Future<void> _loadData() async {
    ...
    final List<String>? transactionsJson = prefs.getStringList('transactions_dez');
    final double? bancaValue = prefs.getDouble('bancaValue_dez');
  ...
  Future<void> _saveData() async {
    ...
    await prefs.setStringList('transactions_dez', transactionsJson);

    await prefs.setDouble('bancaValue_dez', _bancaValue);
  }
