...
import 'package:open_file/open_file.dart';
 // Importe isso para inicializar os dados de localização
...
class AgostoReport extends StatefulWidget {
  @override
  _AgostoReportReportState createState() => _AgostoReportReportState();
}

class _AgostoReportReportState extends State<AgostoReport > {
  ...
  Future<void> _loadData() async {
    ...
    final List<String>? transactionsJson = prefs.getStringList('transactions_agosto');
    final double? bancaValue = prefs.getDouble('bancaValue_agosto');
  ...
  Future<void> _saveData() async {
    ...
    await prefs.setStringList('transactions_agosto', transactionsJson);

    await prefs.setDouble('bancaValue_agosto', _bancaValue);
  }
 @override
  void initState() {
