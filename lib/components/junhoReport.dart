...
class JunhoReport extends StatefulWidget {
  @override
  _JunhoReportReportState createState() => _JunhoReportReportState();
}

class _JunhoReportReportState extends State<JunhoReport > {
  ...
  Future<void> _loadData() async {
    ...
    final List<String>? transactionsJson = prefs.getStringList('transactions_junho');
    final double? bancaValue = prefs.getDouble('bancaValue_junho');
  ...
  Future<void> _saveData() async {
    ...
    await prefs.setStringList('transactions_junho', transactionsJson);

    await prefs.setDouble('bancaValue_junho', _bancaValue);
  }
