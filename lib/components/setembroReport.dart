...
class SetembroReport extends StatefulWidget {
  @override
   _SetembroReportState createState() => _SetembroReportState();
}

class  _SetembroReportState extends State<SetembroReport> {
  ...
  Future<void> _loadData() async {
    ...
    final List<String>? transactionsJson = prefs.getStringList('transactions_set');
    final double? bancaValue = prefs.getDouble('bancaValue_set');
  ...
  Future<void> _saveData() async {
    ...
    await prefs.setStringList('transactions_set', transactionsJson);

    await prefs.setDouble('bancaValue_set', _bancaValue);
  }
