...
class NovReport extends StatefulWidget {
  @override
   _NovReportState createState() => _NovReportState();
}

class  _NovReportState extends State<NovReport> {
  ...
  Future<void> _loadData() async {
    ...
    final List<String>? transactionsJson = prefs.getStringList('transactions_nov');
    final double? bancaValue = prefs.getDouble('bancaValue_nov');
  ...
  Future<void> _saveData() async {
    ...
    await prefs.setStringList('transactions_nov', transactionsJson);

    await prefs.setDouble('bancaValue_nov', _bancaValue);
  }
